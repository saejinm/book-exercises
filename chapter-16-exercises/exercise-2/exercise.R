...
ggplot(data = diamonds) +
  geom_col(mapping = aes(x = cut, y = price, fill = clarity), posititon = "fill")


# Draw the same chart again, but with each element positioned to "dodge" each other
ggplot(data = diamonds) +
  geom_col(mapping = aes(x = cut, y = price, fill = clarity), posititon = "dodge")
...
# previous exercise).
ggplot(data = diamonds) +
  geom_col(mapping = aes(x = cut, y = price), posititon = "jitter")
...
ggplot(data = diamonds) +
  geom_point(mapping = aes(x = caret, y = price, color = clarity)) +
